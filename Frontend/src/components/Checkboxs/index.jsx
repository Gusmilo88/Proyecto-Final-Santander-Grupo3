...
const Checkboxs = ({setEventosFiltrados}) => {
    ...
    let [categoriaSeleccionada, setCategoriaSeleccionada] = useState({
        checkboxConcert: false,
        checkboxFood: false,
        checkboxCinema: false,
        checkboxMuseum: false,
        checkboxBooks: false,
        checkboxRace: false,
        checkboxParty: false,
    })
    ...
    const handleOnCheckbox = (e) => {
        setCategoriaSeleccionada({
            ...categoriaSeleccionada, //Acá creamos una copia usando el operador de propagación (NO modifica el original)
  ...
  useEffect(() => {
    ...
    .then((response) => {
      setEventos(response.data.events) //Seteamos eventos con events
    //   setDatosFiltrados(response.data.events)
    })
  },[])
    ...
    <div>
      ...
      <span id="spanCheckbox" className="absolute inset-0 flex items-center justify-center text-white">
        ...
        >
          ...
          >
            <img
              src="/src/assets/images/museum.png"
              alt="Museum"
              className="w-full h-full object-cover absolute top-0 left-0 grayscale transition-all duration-300"
              id="checkboxImage"
            />
      ...
      <span id="spanCheckbox" className="absolute inset-0 flex items-center justify-center text-white">
        ...
        >
          ...
          >
            <img
              src="/src/assets/images/race.jpg"
              alt="Museum"
              className="w-full h-full object-cover absolute top-0 left-0 grayscale transition-all duration-300"
              id="checkboxImage"
            />
