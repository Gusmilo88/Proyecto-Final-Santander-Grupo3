    ...
    <table className="table">
      ...
      <tbody>
        <tr>
          <td>
            <div className="product-item">
              <Link className="product-thumb" href="#"><img src="https://www.bootdey.com/image/220x180/FF0000/000000" alt="Product" /></Link>
              <div className="product-info">
                <h4 className="product-title"><Link href="#">Unionbay Park</Link></h4>
              </div>
            </div>
          </td>
        ...
        <tr>
          <td>
            <div className="product-item">
              <Link className="product-thumb" href="#"><img src="https://www.bootdey.com/image/220x180/5F9EA0/000000" alt="Product" /></Link>
              <div className="product-info">
                <h4 className="product-title"><Link href="#">Daily Fabric Cap</Link></h4>
              </div>
            </div>
          </td>
          <td className="text-center">
        ...
        <tr>
          <td>
            <div className="product-item">
              <Link className="product-thumb" href="#"><img src="https://www.bootdey.com/image/220x180/9932CC/000000" alt="Product" /></Link>
              <div className="product-info">
                <h4 className="product-title"><Link href="#">Cole Haan Crossbody</Link></h4>
              </div>
            </div>
          </td>
          <td className="text-center">
